Contributing to Aegeus
============================

The Aegeus project operates an open contributor model where anyone is
...
The following applies to code changes to the Aegeus project, and is not to be
confused with overall AEGEUS Network Protocol consensus changes.

Whether a pull request is merged into Aegeus rests with the project merge
...
Patches that change AEGEUS consensus rules are considerably more involved than
...
Where a patch set proposes to change the AEGEUS consensus, it must have been
...
The project leader is the release manager for each Aegeus release.

...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Aegeus features */
        {"aegeus", "masternode", &masternode, true, true, false},
        {"aegeus", "listmasternodes", &listmasternodes, true, true, false},
        {"aegeus", "getmasternodecount", &getmasternodecount, true, true, false},
        {"aegeus", "masternodeconnect", &masternodeconnect, true, true, false},
        {"aegeus", "masternodecurrent", &masternodecurrent, true, true, false},
        {"aegeus", "masternodedebug", &masternodedebug, true, true, false},
        {"aegeus", "startmasternode", &startmasternode, true, true, false},
        {"aegeus", "createmasternodekey", &createmasternodekey, true, true, false},
        {"aegeus", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"aegeus", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"aegeus", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"aegeus", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"aegeus", "getmasternodescores", &getmasternodescores, true, true, false},
        {"aegeus", "mnbudget", &mnbudget, true, true, false},
        {"aegeus", "preparebudget", &preparebudget, true, true, false},
        {"aegeus", "submitbudget", &submitbudget, true, true, false},
        {"aegeus", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"aegeus", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"aegeus", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"aegeus", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"aegeus", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"aegeus", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"aegeus", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"aegeus", "checkbudgets", &checkbudgets, true, true, false},
        {"aegeus", "mnsync", &mnsync, true, true, false},
        {"aegeus", "spork", &spork, true, true, false},
        {"aegeus", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"aegeus", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use aegeusd, or the -server option to aegeus-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> aegeus-cli " + methodname + " " + args + "\n";
}

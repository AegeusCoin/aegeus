...
// Copyright (c) 2015-2017 The PIVX Developers, The AEG Developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (502598, uint256("0x6c787b71582de3d13e860c5224bae48cfb866678d52f4b68eb3c603910afec1b"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1548906274, // * UNIX timestamp of last checkpoint block
    1096530,    // * total number of transactions between genesis and last checkpoint
...
public:
    CTestNetParams()
    {
        ...
        // Testnet aegeus BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Aegeus: 1 day
        nTargetSpacing = 1 * 60;        // Aegeus: 1 minutes

...
/** Utility functions used by the AEGEUS Qt UI.
 */
namespace GUIUtil
{
...
// Render AEGEUS addresses in monospace font
...
// Parse "aegeus:" URI into recipient object, return true on successful parsing

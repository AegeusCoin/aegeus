...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Aegeus"), this);
    aboutAction->setStatusTip(tr("Show information about Aegeus"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AEGEUS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AEGEUS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AEGEUS addresses"));
    ...
    openAction->setStatusTip(tr("Open a AEGEUS: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Aegeus help message to get a list with possible AEGEUS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Aegeus client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AEGEUS network", "", count));
}
...
{
    QString strTitle = tr("Aegeus"); // default title

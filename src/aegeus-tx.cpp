...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Aegeus aegeus-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  aegeus-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded aegeus transaction") + "\n" +
                               "  aegeus-tx [options] -create [commands]   " + _("Create hex-encoded aegeus transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded aegeus transaction

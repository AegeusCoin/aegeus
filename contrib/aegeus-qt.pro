...
RESOURCES += src/qt/aegeus.qrc src/qt/aegeus_locale.qrc

TRANSLATIONS += src/qt/locale/aegeus_bg.ts \
                src/qt/locale/aegeus_de.ts \
                src/qt/locale/aegeus_en.ts \
                src/qt/locale/aegeus_es.ts \
                src/qt/locale/aegeus_fi.ts \
                src/qt/locale/aegeus_fr.ts \
                src/qt/locale/aegeus_it.ts \
                src/qt/locale/aegeus_ja.ts \
                src/qt/locale/aegeus_pl.ts \
                src/qt/locale/aegeus_pt.ts \
                src/qt/locale/aegeus_ru.ts \
                src/qt/locale/aegeus_sk.ts \
                src/qt/locale/aegeus_sv.ts \
                src/qt/locale/aegeus_vi.ts \
                src/qt/locale/aegeus_zh_CN.ts \
                src/qt/locale/aegeus_zh_TW.ts

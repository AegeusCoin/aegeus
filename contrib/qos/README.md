...
This means one can have an always-on aegeusd instance running, and another local aegeusd/aegeus-qt instance which connects to this node and receives blocks from it.

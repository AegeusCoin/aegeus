...
In order to support loading of multiple wallets in aegeus-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is aegeus.cpp.
...
Changes to aegeus.cpp
----------------------
aegeus.cpp is the entry point into aegeus-qt, and as such, will require some minor modifications to provide hooks for
